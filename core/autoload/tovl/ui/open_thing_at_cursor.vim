...
function! tovl#ui#open_thing_at_cursor#AddOnThingHandler(handler)
...
function! tovl#ui#open_thing_at_cursor#HandleOnThing()
  let pos = getpos('.')
  let possibleFiles = []
...
function! tovl#ui#open_thing_at_cursor#OnThingTagList(tag)
  let l = []
